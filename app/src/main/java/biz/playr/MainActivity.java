...
//		}
	...
	private void reportSystemInformation() {
		...
		Log.e(className, "***                            ==================                            ***");
		Log.e(className, "***                                                                          ***");
		Log.e(className, "***      Android API level: " + paddedOut(String.valueOf(Build.VERSION.SDK_INT), 49) + "***");
		Log.e(className, "***             target SDK: " + paddedOut(String.valueOf(getApplicationInfo().targetSdkVersion), 49) + "***");
		Log.e(className, "***     Android build date: " + paddedOut(String.valueOf(new Date(Build.TIME)), 49) + "***");
		Log.e(className, "***           manufacturer: " + paddedOut(Build.MANUFACTURER, 49) + "***");
		Log.e(className, "***                  brand: " + paddedOut(Build.BRAND, 49) + "***");
		Log.e(className, "***                product: " + paddedOut(Build.PRODUCT, 49) + "***");
		Log.e(className, "***                  model: " + paddedOut(Build.MODEL, 49) + "***");
		Log.e(className, "***               hardware: " + paddedOut(Build.HARDWARE, 49) + "***");
		Log.e(className, "***                 device: " + paddedOut(Build.DEVICE, 49) + "***");
		Log.e(className, "***                  board: " + paddedOut(Build.BOARD, 49) + "***");
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            Log.e(className, "***       soc manufacturer: " + paddedOut(Build.SOC_MANUFACTURER, 49) + "***");
			Log.e(className, "***              soc model: " + paddedOut(Build.SOC_MODEL, 49) + "***");
        }
		Log.e(className, "***                UI mode: " + paddedOut(uiModeStatus(), 49) + "***");
		Log.e(className, "***             debuggable: " + paddedOut(String.valueOf(
				(getApplicationInfo().flags & ApplicationInfo.FLAG_DEBUGGABLE) != 0), 49) + "***");
		Log.e(className, "***                                                                          ***");
		Log.e(className, "***             auto start: " + paddedOut(String.valueOf(getResources().getBoolean(R.bool.auto_start)), 49) + "***");
		Log.e(className, "***                restart: " + paddedOut(String.valueOf(getResources().getBoolean(R.bool.restart)), 49) + "***");
		Log.e(className, "***         https required: " + paddedOut(String.valueOf(httpsRequired()), 49) + "***");
		Log.e(className, "***                                                                          ***");
		Log.e(className, "***     full-screen intent: " + paddedOut(AppRestarter.fullScreenIntentStatus(this), 49) + "***");
		Log.e(className, "***           exact alarms: " + paddedOut(AppRestarter.exactAlarmStatus(this), 49) + "***");
		Log.e(className, "***                overlay: " + paddedOut(overlayStatus(), 49) + "***");
		Log.e(className, "***          notifications: " + paddedOut(notificationsStatus(), 49) + "***");
		Log.e(className, "***         launch channel: " + paddedOut(launchNotificationChannelStatus(), 49) + "***");
		Log.e(className, "***      battery exemption: " + paddedOut(batteryOptimizationStatus(), 49) + "***");
		Log.e(className, "***                network: " + paddedOut(networkStatus(), 49) + "***");
		Log.e(className, "***                                                                          ***");
		...
		Log.e(className, "***         FGS specialUse: " + paddedOut(permissionStatus("android.permission.FOREGROUND_SERVICE_SPECIAL_USE"), 49) + "***");
		...
		Log.e(className, "***                                                                          ***");
		Log.e(className, "***            app version: " + paddedOut(versionInfo.get("appVersion"), 49) + "***");
		Log.e(className, "***        webview version: " + paddedOut(versionInfo.get("webviewVersion"), 49) + "***");
		Log.e(className, "***                                                                          ***");
		Log.e(className, "********************************************************************************");
	}
